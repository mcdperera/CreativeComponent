...
public class Client : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        //playerWonTrickCountText.text = "1";

        //opponentWonTrickCountText.text = "1";
    ...
    private void loadselectedTrumph(BiddingMessage message)
    {
        ...
        goButton.transform.localScale = new Vector3(1f, 1f, 1f);
    ...
    void loadPanelCardButtons(List<String> cards, bool isInteractable)
    {
        ...
        foreach (String card in cards)
        {
            ...
            goButton.transform.localScale = new Vector3(100f, 100f, 100f);
