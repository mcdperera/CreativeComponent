...
#pragma warning restore 649
    ...
    public void OnGUI()
    {
        using (GUILayout.ScrollViewScope scrollViewScope = new GUILayout.ScrollViewScope(scrollPosition))
        {
            ...
            {
                EditorGUILayout.HelpBox("Checking for updates...", UnityEditor.MessageType.Info);
                return;
            }

            if (latestRelease == null)
            {
                EditorGUILayout.HelpBox("There was a problem checking for updates.", UnityEditor.MessageType.Error);
            ...
            EditorGUILayout.HelpBox(
                ...
                isUpToDate ? UnityEditor.MessageType.Info : UnityEditor.MessageType.Warning);
