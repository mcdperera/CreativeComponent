...
public class SteamVR_Update : EditorWindow
{
	...
	public void OnGUI()
	{
		EditorGUILayout.HelpBox("A new version of the SteamVR plugin is available!", UnityEditor.MessageType.Warning);
		...
		if (notes != "")
		{
			...
			EditorGUILayout.HelpBox(notes, UnityEditor.MessageType.Info);
		}
